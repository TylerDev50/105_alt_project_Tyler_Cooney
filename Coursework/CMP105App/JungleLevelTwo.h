...
class JungleLevelTwo : public Scene
{
public:
    JungleLevelTwo(sf::RenderWindow& window, Input& input,
...
private:
    ...
    void checkMonkeyDialogue(float dt);
    void checkRubbleCollisions();
